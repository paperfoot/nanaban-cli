...
// The canonical text lives in SKILL.md at the repo root; this constant is
// generated from it by scripts/sync-skill.mjs and asserted identical by the
// contract tests, so the installed skill can never drift from the documented one.
