...
class Nanaban < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/paperfoot/nanaban-cli/releases/download/v6.0.0/nanaban-darwin-arm64"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE"
    else
      url "https://github.com/paperfoot/nanaban-cli/releases/download/v6.0.0/nanaban-darwin-x64"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/paperfoot/nanaban-cli/releases/download/v6.0.0/nanaban-linux-arm64"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE"
    else
      url "https://github.com/paperfoot/nanaban-cli/releases/download/v6.0.0/nanaban-linux-x64"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE"
    end
  end
